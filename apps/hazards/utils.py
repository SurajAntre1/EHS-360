...
def generate_hazard_pdf(hazard):
    ...
    overview_data = [
        ...
        [Paragraph("<b>Current Status:</b>", styles['Label']), Paragraph(hazard.get_status_display(), styles['Value']), Paragraph("<b>Approval Status:</b>", styles['Label']), Paragraph(hazard.get_approval_status_display(), styles['Value'])],
